<div class="p-6 max-w-5xl mx-auto space-y-6">
    ...
    <form wire:submit="save" class="space-y-6">
        ...
        <div class="bg-white border rounded-xl p-5 space-y-3">
            <div class="flex justify-between"><h3 class="text-sm font-semibold">Subsecciones</h3><button type="button" wire:click="addSubSection" class="text-xs text-blue-600">+ Agregar</button></div>
        ...
        <div class="bg-white border rounded-xl p-5 space-y-3">
            <div class="flex justify-between"><h3 class="text-sm font-semibold">Series y retención</h3><button type="button" wire:click="addSerie" class="text-xs text-blue-600">+ Agregar</button></div>
        ...
        <div class="bg-white border rounded-xl p-5 space-y-3">
            <div class="flex justify-between"><h3 class="text-sm font-semibold">Subseries</h3><button type="button" wire:click="addSubSerie" class="text-xs text-blue-600">+ Agregar</button></div>
