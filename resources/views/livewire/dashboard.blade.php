<div class="p-6 max-w-7xl mx-auto space-y-6">
    <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pb-4 border-b border-slate-200">
        ...
        <a href="{{ route('proceedings.index') }}" wire:navigate class="px-3 py-1.5 text-xs font-medium text-white bg-blue-600 rounded-lg">Ver Expedientes</a>
    </div>
    ...
    <div class="bg-white p-5 rounded-xl border border-slate-200">
        ...
        @forelse($recentAlerts as $alert)
            <div class="text-xs border border-rose-100 bg-rose-50 rounded-lg p-3 mb-2">
